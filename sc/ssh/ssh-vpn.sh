...
curl -sS https://raw.githubusercontent.com/Farukbrowser/vclan/main/sc/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/Farukbrowser/vclan/main/sc/ssh/nginx.conf"
mkdir -p /home/vps/public_html
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/Farukbrowser/vclan/main/sc/ssh/newudpgw"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/Farukbrowser/vclan/main/sc/issue.net"
chmod +x /etc/issue.net
echo "Banner /etc/issue.net" >> /etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear

#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/Farukbrowser/vclan/main/sc/ssh/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
wget -O xmenu "https://raw.githubusercontent.com/Farukbrowser/vclan/main/sc/menu/xmenu.sh"
wget -O tmenu "https://raw.githubusercontent.com/Farukbrowser/vclan/main/sc/menu/tmenu.sh"
...
cd
cd /usr/bin
wget -q -O limit-ssh "https://raw.githubusercontent.com/Farukbrowser/vclan/main/sc/limit/limit-ssh"
chmod +x limit-ssh
cd
