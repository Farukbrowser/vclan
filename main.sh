...
read -p " Enter User Script ( free ) : " usersc
...
if [ "$(systemd-detect-virt)" == "openvz" ]; then
  ...
  sleep 1
  echo -e "[ ${tyblue}NOTES${NC} ] Auto Script VPS By 24CLAN.NET"
  sleep 1
...
echo -e "
 ...
 ───│    $Green├─┤│ │ │ │ │└─┐│  ├┬┘│├─┘ │   │  │ │ ├┤ $NC   │───
 ───│    $Green┴ ┴└─┘ ┴ └─┘└─┘└─┘┴└─┴┴   ┴   ┴─┘┴ ┴ └─┘$NC   │───
    │    ${YELLOW}Copyright${FONT} (C)$GRAY https://github.com/Farukbrowser$NC       │
    └───────────────────────────────────────────────┘
          ${RED} SCRIPT AUTO INSTALL FREE ${FONT}    
           ${RED} SCRIPT MOD BY FARUKBROWSER ${FONT}
   ${RED}DO NOT USE VPN SERVICE FOR INSTALLATION !${FONT}"
 }
checking_sc
...
gotop_latest="$(curl -s https://api.github.com/repos/xxxserxxx/gotop/releases | grep tag_name | sed -E 's/.*"v(.*)".*/\1/' | head -n 1)"
    ...
    wget -q https://raw.githubusercontent.com/Farukbrowser/vclan/main/sc/xray/bbr.sh &&  chmod +x bbr.sh && ./bbr.sh
...
echo ""
if [[ $host == "1" ]]; then
echo -e "   \e[1;32mEnter your domain !$NC"
read -p "   Subdomain: " pp
echo "$pp" > /root/domain
echo "IP=$pp" > /var/lib/xdxl/ipvps.conf
elif [[ $host == "2" ]]; then
wget -q https://raw.githubusercontent.com/Farukbrowser/vclan/main/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
sleep 2
clear
wget https://raw.githubusercontent.com/Farukbrowser/vclan/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
# install backup
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green          Install backup             $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
wget https://raw.githubusercontent.com/Farukbrowser/vclan/main/sc/backup/set-br && chmod +x set-br.sh && ./set-br.sh
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
sleep 2
clear
wget https://raw.githubusercontent.com/Farukbrowser/vclan/main/insxray.sh && chmod +x insxray.sh && ./insxray.sh
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green          Install Websocket             $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/Farukbrowser/vclan/main/sc/sshws/dropbear-ws.py
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/Farukbrowser/vclan/main/sc/sshws/ws-stunnel
chmod +x /usr/local/bin/ws-dropbear
chmod +x /usr/local/bin/ws-stunnel

wget https://raw.githubusercontent.com/Farukbrowser/vclan/main/free.zip
unzip free.zip
chmod +x menu/*
